<template>
  <div>
    ...
    <NewPlanetInput :planet="planet" @clickAddPlanetEvent="addPlanet"
    @pictureInputSuccess="setPlanetImage"/>
...
export default {
  ...
  methods: {
    addPlanet: function () {
      ...
      let copyOfPlanet = JSON.parse(planetAsString)
      this.planets.push(copyOfPlanet)
    },
    setPlanetImage: function (planetImage) {
      this.planet.planetImage = planetImage;
    }
